  ...
  return (
    <div style={{ flex:1, overflowY:'auto', scrollbarWidth:'none' }}>
      ...
      <div style={{ padding: '14px 18px 12px', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        <div>
          <div style={{ color: NEON.textDim, fontSize: 11, textTransform: 'uppercase', letterSpacing:'0.18em', fontFamily:'Bebas Neue, sans-serif' }}>{dayLabel}</div>
          <div className="font-script" style={{ color: NEON.text, fontSize: 44, fontWeight: 700, letterSpacing: '-0.5px', lineHeight: 0.95, marginTop: 4 }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            <div style={{ display:'flex', alignItems:'center', gap: 6, marginBottom: 4 }}>
              ...
              <span style={{ color: NEON.orange, fontSize: 10, fontWeight: 700, letterSpacing: '0.14em', fontFamily:'Bebas Neue, sans-serif' }}>PROSSIMA GARA</span>
            </div>
            <div className="font-script" style={{ color: NEON.text, fontSize: 38, fontWeight: 700, lineHeight: 0.95, letterSpacing:'-0.5px' }}>{USER.raceName}</div>
            <div style={{ color: NEON.textDim, fontSize: 11.5, marginTop: 6, letterSpacing:'0.06em', textTransform:'uppercase', fontFamily:'Bebas Neue, sans-serif' }}>{USER.raceDate} · 21.097 km</div>
